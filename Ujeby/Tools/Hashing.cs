...
namespace Ujeby.Tools
{
	public static class Hashing
	{
		...
		public static string HashSha512(string source, SHA512 sha512 = null) => Hash(source, sha512 ?? _sha512);
		...
		public static string SafeHashSha512(string source) => FormatHash(SHA512.HashData(FormatSource(source)));
